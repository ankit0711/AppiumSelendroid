...
public class LogUtil {
	...
	public static void errorMessageWithStackTrace(String testCaseID,String message, Throwable throwable) {
        logger.error("ERROR EXECUTING TEST CASE ID " + testCaseID + "\t");
        logger.error("===========================================================================================================================");
